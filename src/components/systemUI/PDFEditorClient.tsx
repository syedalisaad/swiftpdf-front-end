...
export default function PDFEditorClient() {
  ...
  return (
    <div className="min-h-screen bg-[#F9FAFB] py-8 px-4 font-sans">
      <div className="mb-1 border-b border-gray-50 pb-1">
        <AdBanner 
      ...
      <div className="flex h-screen bg-[#F8FAFC] overflow-hidden">
        ...
        <aside className="w-20 bg-white border-r border-slate-200 flex flex-col items-center py-6 gap-6 z-50">
          <div className="text-red-600 font-black italic text-xl underline decoration-2 underline-offset-4">
            SB
          </div>
          <button
        ...
        <div className="flex-1 flex flex-col relative">
          ...
          <header className="h-16 bg-white border-b border-slate-200 px-8 flex items-center justify-between z-40">
            ...
            <button
              ...
              className="bg-red-600 text-white px-6 py-2 rounded-lg text-xs font-black flex items-center gap-2 hover:bg-red-700 transition-colors shadow-sm"
            >
              {downloading ? (

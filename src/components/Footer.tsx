      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          <div className="flex flex-col space-y-3">
            <h3 className="font-bold text-gray-800 text-xs uppercase tracking-widest mb-2">Company</h3>
          ...
          <div className="flex flex-col space-y-3">
            <h3 className="font-bold text-gray-800 text-xs uppercase tracking-widest mb-2">Legal</h3>
            <Link href="/privacy-policy" className="text-sm text-gray-500 hover:text-red-600 transition-colors">Privacy Policy</Link>
            <Link href="/terms" className="text-sm text-gray-500 hover:text-red-600 transition-colors">Terms of Service</Link>
            <p className="text-[10px] text-gray-400 mt-4 leading-tight italic">
              * This site uses cookies for analytics and personalized ads via Google AdSense.
            </p>
          </div>
        </div>

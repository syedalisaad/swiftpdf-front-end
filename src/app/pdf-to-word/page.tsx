      ...
      <section className="bg-white py-16 px-4 border-b border-gray-100 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed mb-8">
            Transform your PDF documents into Microsoft Word files that you can
            edit. Our system rebuilds your document layout keeping the fonts,
            tables and images exactly as they are. This way you get editable
            Microsoft Word files.
          </p>
          <h2 className="text-2xl font-bold text-gray-800">
            Professional Grade DOCX Conversion
          </h2>
          <p className="text-gray-500 mt-2">
            The easiest way to make your PDF documents editable again.
          </p>
        </div>
      </section>

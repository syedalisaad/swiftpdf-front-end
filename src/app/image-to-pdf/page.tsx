...
export default function ImageToPDFPage() {
  ...
  const handleConvert = async () => {
    ...
    // Simulating the image processing and backend call
    setTimeout(() => {
      setStatus("success");
    }, 4000); 
  };
  ...
  return (
    <div className="min-h-screen bg-[#F9FAFB] py-12 px-4 font-sans">
      <div className="max-w-4xl mx-auto">
        {/* Navigation */}
        <Link href="/" className="inline-flex items-center text-gray-500 hover:text-purple-600 mb-8 transition-colors group">
          ...
          <div className="p-6 md:p-10">
                ...
                {!file ? (
                  ...
                  <div className="relative group">
                    ...
                    >
                      ...
                      <h2 className="text-2xl font-bold text-gray-800 mb-2">Select an Image file</h2>
                      <p className="text-gray-400 font-medium">Upload JPG, PNG, or WEBP</p>
                    </label>
                  </div>
                ) : (
                  /* Selected File State */
                  <div className="space-y-8">
                    {/* Assuming FileCard is adaptable or handles non-PDF file icons via prop/config */}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="bg-purple-50/50 p-4 rounded-2xl border border-purple-100 flex items-center gap-3">
                            ...
                            <p className="text-xs font-semibold text-purple-800">Auto Page-Fit Placement</p>
                        </div>
                        <div className="bg-purple-50/50 p-4 rounded-2xl border border-purple-100 flex items-center gap-3">
                            <ShieldCheck className="text-purple-600" size={20} />
                            <p className="text-xs font-semibold text-purple-800">Original Quality Retention</p>
                        </div>
                    </div>
            ...
            {status === "processing" && (
              <div className="py-20 text-center space-y-6">
                <div className="relative w-24 h-24 mx-auto">
                    <Loader2 className="animate-spin text-purple-500 absolute inset-0" size={96} strokeWidth={1} />
                    <div className="absolute inset-0 flex items-center justify-center">
                        <ImageIcon className="text-purple-200" size={32} />
                    </div>
                </div>
                <div>
                    <h2 className="text-2xl font-bold text-gray-800">Processing Image...</h2>
                    <p className="text-gray-400 mt-2 font-medium italic">Optimizing layout and creating PDF pages.</p>
                </div>
              </div>
            )}
            ...
            {status === "success" && (
              <div className="py-10 text-center animate-in zoom-in-95 duration-500">
                ...
                <p className="text-gray-500 mb-10 max-w-xs mx-auto">Your image has been perfectly converted into a clean PDF document.</p>

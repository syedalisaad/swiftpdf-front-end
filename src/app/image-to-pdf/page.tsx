      ...
      <section className="bg-white py-16 px-4 border-b border-gray-100">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-4xl md:text-5xl font-black text-gray-900 mb-6 tracking-tight">
            Convert <span className="text-red-600">Images to PDF</span>{" "}
            Instantly for Free
          </h1>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            You can put all your photos together in one document. To do this you
            need to upload your **JPG, PNG or WEBP** files. Then you can make a
            good **PDF** in just a few seconds. This is a way to make a **PDF**,
            from your **JPG, PNG or WEBP** files.
          </p>
          {/* New H2 Section for SEO Hierarchy */}
          <h2 className="text-2xl font-bold text-gray-800">
            Fast, Secure, and High-Resolution Image Conversion
          </h2>
          <p className="text-gray-500 mt-2">
            No watermarks, no sign-ups, and no limits.
          </p>
        </div>
      </section>

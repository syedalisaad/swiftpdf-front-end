      ...
      <div className="max-w-6xl mx-auto px-4 pt-16">
        <header className="text-center mb-16">
          ...
          <h2 className="text-slate-500 text-xl max-w-2xl mx-auto font-medium leading-relaxed">
            Fast, secure, and free document workflows for everyone. Convert,
            edit, and manage your files directly in your browser without
            installations.
          </h2>
        </header>
        ...
        <section className="bg-white rounded-[40px] p-10 border border-red-50/50 shadow-[0_20px_50px_rgba(220,38,38,0.03)] mb-16">
          ...
          <div className="grid md:grid-cols-2 gap-8 text-slate-600 text-sm leading-relaxed">
            <p>
              Managing business paperwork shouldn't take hours. Whether you need
              to
              <strong> merge PDF files</strong>, extract specific pages with our
              <strong> split PDF engine</strong>, or convert scans using optical
              recognition, swiftpdf brings local desktop speed straight to your
              browser. No registration required.
            </p>
            <p>
              Security is our benchmark. All files uploaded to our server are
              treated with end-to-end encryption and automatically wiped from
              our temporary caching directory after processing, meeting standard
              regulatory measures for digital privacy.
            </p>
          </div>
        </section>

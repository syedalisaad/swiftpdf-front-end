...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Transform PDFs into natural-sounding audio with our secure AI Document Reader.",
...
Then you can create the PDF document.`
    ...
    },
    {
      ...
      answer: `Yes. You can turn speech into PDF on any device using a web browser.
      ...
      <section className="bg-white py-16 px-4 border-b border-gray-100 text-center">
        ...
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl md:text-5xl font-black text-gray-900 mb-6 tracking-tight">
            AI PDF Reader:{" "}
            <span className="text-red-600">Listen to Your Documents</span>
          </h1>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed">
            You can turn PDF documents into voices that sound like people. This
            means you can listen to your reports or books or scripts when you
            are working or traveling to work. You can hear your PDF documents
            read out loud in a voice. This is great for people who want to
            listen to their PDF documents, like reports or books or scripts when
            they are doing something.
          </p>
          <h2 className="text-2xl font-bold text-gray-800">
            Natural Text-to-Speech for Every Document
          </h2>
          <p className="text-gray-500 mt-2">
            Experience the best neural voices for your books, reports, and
            scripts.
          </p>
        </div>
      </section>

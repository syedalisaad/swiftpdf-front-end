      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-[2rem] shadow-[0_20px_50px_rgba(0,0,0,0.05)] overflow-hidden border border-gray-100">
          ...
          <div className="p-6 md:p-10">
                ...
                {files.length === 0 ? (
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex flex-col md:flex-row gap-4 pt-8">
                      ...
                      <button className="flex-[2] py-4 px-8 bg-red-600 text-white rounded-2xl font-extrabold text-lg shadow-xl shadow-red-200 hover:bg-red-700 hover:shadow-red-300 transition-all active:scale-95 flex items-center justify-center gap-2">
            ...
            {/* Processing and Success states remain largely same but with better typography... */}
          </div>
        </div>
